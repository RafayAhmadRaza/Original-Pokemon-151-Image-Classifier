...
df = pd.read_csv(r"D:\Original Pokemon 151 Image Classifier\PokemonFacts\PokemonFacts.csv")
df.columns = df.columns.str.strip()
df['Names'] = df['Names'].str.strip()
modelDict = {"Best Model":"D:\Original Pokemon 151 Image Classifier\my_model11.keras","Second Best":"D:\Original Pokemon 151 Image Classifier\my_model3.keras","Worst":"D:\Original Pokemon 151 Image Classifier\my_model.keras"}
def main():
    st.title('🔴Pokemon 151 Classifier⚪')
